...
switch (code) {
    case 4653:
        console.log(`Сумма к оплате с учётом скидки ${0.7 * sum}`);
        break;
    case 5698:
    case 5111:
        console.log(`Сумма к оплате с учётом скидки ${0.8 * sum}`);
        break;
    case 6922:
    case 6113:
    case 6099:
        console.log(`Сумма к оплате с учётом скидки ${0.9 * sum}`);
        break;
    default:
        console.log(`Скидка не применена, сумма к оплате ${sum}`);
}
//Задача 3
